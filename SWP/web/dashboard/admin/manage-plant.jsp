...
<<<<<<< HEAD
        ...
        function editPlant(plantId) {
            ...
            if (!plant) return;
            document.getElementById('editPlantId').value = plant.plantId;
            document.getElementById('editName').value = plant.name;
            document.getElementById('editDescription').value = plant.description;
            document.getElementById('editPrice').value = plant.price;
            document.getElementById('editStockQuantity').value = plant.stockQuantity;
            document.getElementById('editCategoryId').value = plant.categoryId;
            // Show current image
...
<<<<<<< HEAD
        ...
        function deletePlant(plantId) {
            const plant = plants.find(p => p.plantId == plantId);
            if (!plant) return;
            if (confirm('Bạn có chắc chắn muốn xóa cây "' + plant.name + '"?\nHành động này không thể hoàn tác!')) {
