...
<!DOCTYPE html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Vườn Cây Hà Nội - Chuyên Mua Bán Cây Xanh</title>
...
<section class="commitment-section">
  <div class="container text-center">
    <h2 class="commitment-title">CAM KẾT TỪ VƯỜN CÂY HÀ NỘI</h2>
    <p class="commitment-subtitle">Công Ty Vườn Cây Hà Nội – Chuyên mua bán cây xanh</p>
