...
<div class="text-center mt-3">
                    <%
                        String googleOAuthUrl = "https://accounts.google.com/o/oauth2/v2/auth"
                                + "?client_id=877308457870-12adf40qri6e508nsue8s9ipe5ntmhr4.apps.googleusercontent.com"
                                + "&redirect_uri=http://localhost:8080/SWPcu/login-google" // Cập nhật context path
                                + "&response_type=code"
                                + "&scope=email%20profile"
                                + "&access_type=online";
                    %>
                    <a href="<%= googleOAuthUrl%>" class="btn btn-outline-danger w-100">
